...
public class Location_Modal_class {
    private double  Longitude,Latitude;
    String driver_name,driver_mobile,driver_age,drivere_mail,driver_Addres,usertype,bus,driver_password;
    public Location_Modal_class() {
    }

    public Location_Modal_class(double longitude, double latitude, String driver_name, String driver_mobile, String driver_age, String drivere_mail, String driver_Addres, String usertype, String bus, String driver_password) {
        Longitude = longitude;
        Latitude = latitude;
