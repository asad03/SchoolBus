...
public class EveningAtten_Bus_Activity extends AppCompatActivity {
    ListView simpleList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_evening_atten_bus);
        ...
        if (textm.equals(morningIn)) {
            databaseReference = FirebaseDatabase.getInstance().getReference("AttendanceEveningIn").child(student_Bus);
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    simpleList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            Intent intent = new Intent(getApplicationContext(), ShowFull_EveningAtten_Activity.class);
...
//                                        intent.putExtra("morningentryTime",morningentryTime);
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(EveningAtten_Bus_Activity.this, R.layout.listview_morningatten, R.id.textView, date);
            ...
            databaseReference = FirebaseDatabase.getInstance().getReference("AttendanceEveningOut").child(student_Bus);
            valueEventListener = databaseReference.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
